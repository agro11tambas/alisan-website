      ...
      <div className="bg-white border-b border-border mb-2 md:mb-4">
        <div className="w-full px-2 sm:container sm:mx-auto sm:px-4 py-1.5 md:py-4">
          <h1 className="text-lg md:text-2xl font-bold text-gray-900">
            {search ? `Hasil pencarian untuk "${search}"` : categoryId ? 'Produk Kategori' : 'Semua Produk Sablon'}
          </h1>
          <p className="text-[10px] md:text-sm text-gray-500 mt-0.5 md:mt-1">Menampilkan {groups.length} produk</p>
        </div>
      </div>
        ...
        <div className="flex flex-col lg:flex-row gap-4 md:gap-8">
          ...
          <aside className="hidden lg:block w-64 shrink-0">
            <div className="bg-white p-4 rounded-xl border border-gray-100 shadow-sm sticky top-24">
              <h2 className="font-semibold text-gray-900 mb-4 pb-2 border-b border-gray-100">Kategori</h2>
