      ...
      <div className="w-full max-w-md bg-white rounded-lg md:rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        <div className="p-2 md:p-6">
          <div className="text-center mb-2 md:mb-6">
            ...
            <p className="text-sm text-gray-500 mt-2">Join Alisan and start shopping today.</p>
          </div>

          <form onSubmit={handleSubmit(onSubmit)} className="space-y-1.5 md:space-y-4">
            <div className="space-y-0.5 md:space-y-1">
              <label className="text-[10px] md:text-xs font-medium text-gray-700">Full Name</label>
            ...
            <div className="space-y-0.5 md:space-y-1">
              <label className="text-[10px] md:text-xs font-medium text-gray-700">Email Address</label>
              <div className="relative">
                <input
                  {...register("email")}
                  className={`w-full h-8 md:h-10 pl-3 md:pl-4 pr-3 md:pr-4 text-xs md:text-sm border rounded focus:ring-1 focus:ring-primary/50 outline-none transition-all ${
            ...
            <div className="space-y-0.5 md:space-y-1">
              <label className="text-[10px] md:text-xs font-medium text-gray-700">WhatsApp Number</label>
              <div className="relative">
                <input
            ...
            <div className="space-y-0.5 md:space-y-1">
              <label className="text-[10px] md:text-xs font-medium text-gray-700">Password</label>
              <div className="relative">
                <input
            ...
            <div className="space-y-0.5 md:space-y-1">
              <label className="text-[10px] md:text-xs font-medium text-gray-700">Confirm Password</label>
              <div className="relative">
                <input
